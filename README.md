...
BuckMaterialShell particularly aims at supporting the **niri** and **Hyprland** compositors, but it does support more wayland compositors with a diminished feature set (no monitor off, workspace switcher, overview integration, etc.):
...
sudo dnf copr enable avengemedia/bucklinux && sudo dnf install cliphist ghostty hyprpicker material-symbols-fonts matugen 
```

...
Plugins are external, dynamically-loaded components that extend BuckBar functionality. Plugins are stored in `~/.config/BuckMaterialShell/plugins/` and have their settings isolated from core Dykwabi settings.

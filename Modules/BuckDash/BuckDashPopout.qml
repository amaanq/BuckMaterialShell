...
BuckPopout {
    ...
    function setTriggerPosition(x, y, width, section, screen) {
        ...
        if (section === "center" && (SettingsData.buckBarPosition === SettingsData.Position.Top || SettingsData.buckBarPosition === SettingsData.Position.Bottom)) {
            const screenWidth = screen ? screen.width : Screen.width
            triggerX = (screenWidth - popupWidth) / 2
            triggerWidth = popupWidth
        } else if (section === "center" && (SettingsData.buckBarPosition === SettingsData.Position.Left || SettingsData.buckBarPosition === SettingsData.Position.Right)) {

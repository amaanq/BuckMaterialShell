        ...
        onEntered: {
            if (root.isVertical && activeWindow && activeWindow.appId && root.parentScreen) {
                ...
                if (tooltipLoader.item) {
                    ...
                    const tooltipX = root.axis?.edge === "left" ? (Theme.barHeight + SettingsData.buckBarSpacing + Theme.spacingXS) : (currentScreen.width - Theme.barHeight - SettingsData.buckBarSpacing - Theme.spacingXS)

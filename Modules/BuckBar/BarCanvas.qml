...
Item {
    ...
    Canvas {
        ...
        property real wing: SettingsData.buckBarGothCornersEnabled ? barWindow._wingR : 0
        property real rt: SettingsData.buckBarSquareCorners ? 0 : Theme.cornerRadius
    ...
    Canvas {
        ...
        Connections {
            target: SettingsData
            function onBuckBarSpacingChanged() { barBorder.requestPaint() }
            function onBuckBarSquareCornersChanged() { barBorder.requestPaint() }

...
Item {
    ...
    Variants {
        ...
        delegate: PanelWindow {
            ...
            readonly property color _bgColor: Qt.rgba(Theme.surfaceContainer.r, Theme.surfaceContainer.g, Theme.surfaceContainer.b, topBarCore?.backgroundTransparency ?? SettingsData.buckBarTransparency)
            ...
            screen: modelData
            implicitHeight: !isVertical ? px(effectiveBarThickness + SettingsData.buckBarSpacing + (SettingsData.buckBarGothCornersEnabled ? _wingR : 0)) : 0
            implicitWidth: isVertical ? px(effectiveBarThickness + SettingsData.buckBarSpacing + (SettingsData.buckBarGothCornersEnabled ? _wingR : 0)) : 0
            color: "transparent"
            ...
            Item {
                ...
                readonly property int barThickness: px(barWindow.effectiveBarThickness + SettingsData.buckBarSpacing)
        ...
        MouseArea {
            ...
            height: !barWindow.isVertical ? px(barWindow.effectiveBarThickness + SettingsData.buckBarSpacing) : undefined
            width: barWindow.isVertical ? px(barWindow.effectiveBarThickness + SettingsData.buckBarSpacing) : undefined
            anchors {
            ...
            Item {
                ...
                transform: Translate {
                    id: topBarSlide
                    x: barWindow.isVertical ? px(topBarCore.reveal ? 0 : (SettingsData.buckBarPosition === SettingsData.Position.Right ? barWindow.implicitWidth : -barWindow.implicitWidth)) : 0
                    y: !barWindow.isVertical ? px(topBarCore.reveal ? 0 : (SettingsData.buckBarPosition === SettingsData.Position.Bottom ? barWindow.implicitHeight : -barWindow.implicitHeight)) : 0
                ...
                Item {
                    id: barUnitInset
                    anchors.fill: parent
                    anchors.leftMargin: !barWindow.isVertical ? px(SettingsData.buckBarSpacing) : (axis.edge === "left" ? px(SettingsData.buckBarSpacing) : 0)
                    anchors.rightMargin: !barWindow.isVertical ? px(SettingsData.buckBarSpacing) : (axis.edge === "right" ? px(SettingsData.buckBarSpacing) : 0)
                    anchors.topMargin: barWindow.isVertical ? px(SettingsData.buckBarSpacing) : (axis.outerVisualEdge() === "bottom" ? 0 : px(SettingsData.buckBarSpacing))
                    anchors.bottomMargin: barWindow.isVertical ? px(SettingsData.buckBarSpacing) : (axis.outerVisualEdge() === "bottom" ? px(SettingsData.buckBarSpacing) : 0)

                    ...
                    Item {
                        ...
                        Item {
                            ...
                            Item {
                                ...
                                anchors.topMargin: !barWindow.isVertical ? SettingsData.buckBarInnerPadding / 2 : Math.max(Theme.spacingXS, SettingsData.buckBarInnerPadding * 0.8)
                                anchors.bottomMargin: !barWindow.isVertical ? SettingsData.buckBarInnerPadding / 2 : Math.max(Theme.spacingXS, SettingsData.buckBarInnerPadding * 0.8)
                                clip: true

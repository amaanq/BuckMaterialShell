...
Item {
    ...
    function addWidgetToSection(widgetId, targetSection) {
        ...
        if (targetSection === "left") {
            widgets = SettingsData.buckBarLeftWidgets.slice()
            widgets.push(widgetObj)
            SettingsData.setBuckBarLeftWidgets(widgets)
        } else if (targetSection === "center") {
            widgets = SettingsData.buckBarCenterWidgets.slice()
            widgets.push(widgetObj)
            SettingsData.setBuckBarCenterWidgets(widgets)
        } else if (targetSection === "right") {
            widgets = SettingsData.buckBarRightWidgets.slice()
            widgets.push(widgetObj)
            SettingsData.setBuckBarRightWidgets(widgets)
        }
    }
    ...
    function handleItemOrderChanged(sectionId, newOrder) {
        if (sectionId === "left")
            SettingsData.setBuckBarLeftWidgets(newOrder)
        else if (sectionId === "center")
            SettingsData.setBuckBarCenterWidgets(newOrder)
        else if (sectionId === "right")
            SettingsData.setBuckBarRightWidgets(newOrder)
    }
    ...
    function getItemsForSection(sectionId) {
        ...
        var widgetData = []
        if (sectionId === "left")
            widgetData = SettingsData.buckBarLeftWidgets || []
        else if (sectionId === "center")
            widgetData = SettingsData.buckBarCenterWidgets || []
        else if (sectionId === "right")
            widgetData = SettingsData.buckBarRightWidgets || []
    ...
    Component.onCompleted: {
        ...
        if (!SettingsData.buckBarLeftWidgets)
            SettingsData.setBuckBarLeftWidgets(defaultLeftWidgets)

        if (!SettingsData.buckBarCenterWidgets)
            SettingsData.setBuckBarCenterWidgets(defaultCenterWidgets)

        if (!SettingsData.buckBarRightWidgets)
            SettingsData.setBuckBarRightWidgets(defaultRightWidgets)
    ...
    BuckFlickable {
        ...
        Column {
                    ...
                    Row {
                        ...
                        BuckButtonGroup {
                            ...
                            onSelectionChanged: (index, selected) => {
                                if (selected) {
                                    switch (index) {
                                        case 0: SettingsData.setBuckBarPosition(SettingsData.Position.Top); break
                                        case 1: SettingsData.setBuckBarPosition(SettingsData.Position.Bottom); break
                                        case 2: SettingsData.setBuckBarPosition(SettingsData.Position.Left); break
                                        case 3: SettingsData.setBuckBarPosition(SettingsData.Position.Right); break
                                    }
                                }
                            }
                        }
            ...
            // BuckBar Auto-hide Section
            StyledRect {
                width: parent.width
                height: buckBarAutoHideSection.implicitHeight + Theme.spacingL * 2
                radius: Theme.cornerRadius
                color: Theme.surfaceContainerHigh
                border.color: Qt.rgba(Theme.outline.r, Theme.outline.g,
                                      Theme.outline.b, 0.2)
                ...
                Column {
                    ...
                    Row {
                        ...
                        BuckToggle {
                            ...
                            anchors.verticalCenter: parent.verticalCenter
                            checked: SettingsData.buckBarAutoHide
                            onToggled: toggled => {
                                           return SettingsData.setBuckBarAutoHide(
                                               toggled)
                                       }
                        }
                    }
                    ...
                    Row {
                        ...
                        BuckToggle {
                            ...
                            anchors.verticalCenter: parent.verticalCenter
                            checked: SettingsData.buckBarVisible
                            onToggled: toggled => {
                                           return SettingsData.setBuckBarVisible(
                                               toggled)
                                       }
                        }
                    }
                    ...
                    Row {
                        ...
                        BuckToggle {
                            ...
                            anchors.verticalCenter: parent.verticalCenter
                            checked: SettingsData.buckBarOpenOnOverview
                            onToggled: toggled => {
                                           return SettingsData.setBuckBarOpenOnOverview(
                                               toggled)
                                       }
                        }
                    }
            ...
            StyledRect {
                width: parent.width
                height: buckBarSpacingSection.implicitHeight + Theme.spacingL * 2
                radius: Theme.cornerRadius
                color: Theme.surfaceContainerHigh
                border.color: Qt.rgba(Theme.outline.r, Theme.outline.g,
                                      Theme.outline.b, 0.2)
                ...
                Column {
                    ...
                    Column {
                        ...
                        Row {
                            ...
                            BuckActionButton {
                                ...
                                anchors.verticalCenter: parent.verticalCenter
                                onClicked: {
                                    SettingsData.setBuckBarSpacing(4)
                                }
                            }
                        ...
                        BuckSlider {
                            ...
                            width: parent.width
                            height: 24
                            value: SettingsData.buckBarSpacing
                            minimum: 0
                            maximum: 32
                            unit: ""
                            showValue: true
                            ...
                            onSliderValueChanged: newValue => {
                                                      SettingsData.setBuckBarSpacing(
                                                          newValue)
                                                  }
                    ...
                    Column {
                        ...
                        Row {
                            ...
                            BuckActionButton {
                                ...
                                anchors.verticalCenter: parent.verticalCenter
                                onClicked: {
                                    SettingsData.setBuckBarBottomGap(0)
                                }
                            }
                        ...
                        BuckSlider {
                            ...
                            width: parent.width
                            height: 24
                            value: SettingsData.buckBarBottomGap
                            minimum: -50
                            maximum: 50
                            unit: ""
                            showValue: true
                            ...
                            thumbOutlineColor: Theme.surfaceContainerHigh
                            onSliderValueChanged: newValue => {
                                                      SettingsData.setBuckBarBottomGap(
                                                          newValue)
                                                  }
                    ...
                    Column {
                        ...
                        Row {
                            ...
                            BuckActionButton {
                                ...
                                anchors.verticalCenter: parent.verticalCenter
                                onClicked: {
                                    SettingsData.setBuckBarInnerPadding(4)
                                }
                            }
                        ...
                        BuckSlider {
                            ...
                            width: parent.width
                            height: 24
                            value: SettingsData.buckBarInnerPadding
                            minimum: 0
                            maximum: 24
                            unit: ""
                            showValue: true
                            ...
                            thumbOutlineColor: Theme.surfaceContainerHigh
                            onSliderValueChanged: newValue => {
                                                      SettingsData.setBuckBarInnerPadding(
                                                          newValue)
                                                  }
                    ...
                    BuckToggle {
                        ...
                        checked: SettingsData.buckBarSquareCorners
                        onToggled: checked => {
                                       SettingsData.setBuckBarSquareCorners(
                                           checked)
                                   }
                    }
                    ...
                    BuckToggle {
                        ...
                        checked: SettingsData.buckBarNoBackground
                        onToggled: checked => {
                                       SettingsData.setBuckBarNoBackground(
                                           checked)
                                   }
                    }
                    ...
                    BuckToggle {
                        ...
                        checked: SettingsData.buckBarGothCornersEnabled
                        onToggled: checked => {
                                       SettingsData.setBuckBarGothCornersEnabled(
                                           checked)
                                   }
                    }
                    ...
                    Column {
                        ...
                        BuckToggle {
                            ...
                            checked: SettingsData.buckBarBorderEnabled
                            onToggled: checked => {
                                           SettingsData.setBuckBarBorderEnabled(checked)
                                       }
                        }
                        ...
                        Column {
                            ...
                            leftPadding: Theme.spacingM
                            spacing: Theme.spacingM
                            visible: SettingsData.buckBarBorderEnabled
                            ...
                            Row {
                                ...
                                BuckButtonGroup {
                                    ...
                                    currentIndex: {
                                        const colorOption = SettingsData.buckBarBorderColor || "surfaceText"
                                        switch (colorOption) {
                                    ...
                                    onSelectionChanged: (index, selected) => {
                                        if (selected) {
                                            ...
                                            if (SettingsData.buckBarBorderColor !== newColor) {
                                                SettingsData.buckBarBorderColor = newColor
                                            }
                                        }
                                    }
                                }
                            ...
                            Column {
                                ...
                                Row {
                                    ...
                                    BuckActionButton {
                                        ...
                                        anchors.verticalCenter: parent.verticalCenter
                                        onClicked: {
                                            SettingsData.buckBarBorderOpacity = 1.0
                                        }
                                    }
                                ...
                                BuckSlider {
                                    ...
                                    width: parent.width
                                    height: 24
                                    value: (SettingsData.buckBarBorderOpacity ?? 1.0) * 100
                                    minimum: 0
                                    maximum: 100
                                    unit: "%"
                                    showValue: true
                                    ...
                                    thumbOutlineColor: Theme.surfaceContainerHigh
                                    onSliderValueChanged: newValue => {
                                        SettingsData.buckBarBorderOpacity = newValue / 100
                                    }
                            ...
                            Column {
                                ...
                                Row {
                                    ...
                                    BuckActionButton {
                                        ...
                                        anchors.verticalCenter: parent.verticalCenter
                                        onClicked: {
                                            SettingsData.buckBarBorderThickness = 1
                                        }
                                    }
                                ...
                                BuckSlider {
                                    ...
                                    width: parent.width
                                    height: 24
                                    value: SettingsData.buckBarBorderThickness ?? 1
                                    minimum: 1
                                    maximum: 10
                                    unit: "px"
                                    showValue: true
                                    ...
                                    thumbOutlineColor: Theme.surfaceContainerHigh
                                    onSliderValueChanged: newValue => {
                                        SettingsData.buckBarBorderThickness = newValue
                                    }
                    ...
                    Rectangle {
                        ...
                        Column {
                            ...
                            anchors.right: buckBarFontScaleControls.left
                            anchors.verticalCenter: parent.verticalCenter
                            ...
                            StyledText {
                                text: I18n.tr("BuckBar Font Scale")
                            ...
                            StyledText {
                                text: I18n.tr("Scale BuckBar font sizes independently")
                                font.pixelSize: Theme.fontSizeSmall
                                color: Theme.surfaceVariantText
                                width: parent.width
                            }
                        ...
                        Row {
                            ...
                            BuckActionButton {
                                ...
                                enabled: SettingsData.buckBarFontScale > 0.5
                                backgroundColor: Theme.surfaceContainerHigh
                                iconColor: Theme.surfaceText
                                onClicked: {
                                    var newScale = Math.max(0.5, SettingsData.buckBarFontScale - 0.05)
                                    SettingsData.setBuckBarFontScale(newScale)
                                }
                            }
                            ...
                            StyledRect {
                                ...
                                StyledText {
                                    ...
                                    text: (SettingsData.buckBarFontScale * 100).toFixed(0) + "%"
                                    font.pixelSize: Theme.fontSizeSmall
                                    font.weight: Font.Medium
                                    color: Theme.surfaceText
                                }
                            ...
                            BuckActionButton {
                                ...
                                iconName: "add"
                                iconSize: Theme.iconSizeSmall
                                enabled: SettingsData.buckBarFontScale < 2.0
                                backgroundColor: Theme.surfaceContainerHigh
                                iconColor: Theme.surfaceText
                                onClicked: {
                                    var newScale = Math.min(2.0, SettingsData.buckBarFontScale + 0.05)
                                    SettingsData.setBuckBarFontScale(newScale)
                                }
                            }
                        }
                    ...
                    RowLayout {
                        ...
                        Rectangle {
                            ...
                            MouseArea {
                                ...
                                onClicked: {
                                    SettingsData.setBuckBarLeftWidgets(
                                                defaultLeftWidgets)
                                    SettingsData.setBuckBarCenterWidgets(
                                                defaultCenterWidgets)
                                    SettingsData.setBuckBarRightWidgets(
                                                defaultRightWidgets)
                                }
                            }
            ...
            Column {
                ...
                StyledRect {
                    ...
                    WidgetsTabSection {
                        ...
                        anchors.fill: parent
                        anchors.margins: Theme.spacingL
                        title: SettingsData.buckBarIsVertical ? I18n.tr("Top Section") : I18n.tr("Left Section")
                        titleIcon: "format_align_left"
                        sectionId: "left"
                        allWidgets: buckBarTab.baseWidgetDefinitions
                        items: buckBarTab.getItemsForSection("left")
                        onItemEnabledChanged: (sectionId, itemId, enabled) => {
                                                  buckBarTab.handleItemEnabledChanged(
                                                      sectionId,
                                                      itemId, enabled)
                                              }
                        onItemOrderChanged: newOrder => {
                                                buckBarTab.handleItemOrderChanged(
                                                    "left", newOrder)
                                            }
                        onAddWidget: sectionId => {
                                         widgetSelectionPopup.allWidgets
                                         = buckBarTab.getWidgetsForPopup()
                                         widgetSelectionPopup.targetSection = sectionId
                                         widgetSelectionPopup.show()
                                     }
                        onRemoveWidget: (sectionId, widgetIndex) => {
                                            buckBarTab.removeWidgetFromSection(
                                                sectionId, widgetIndex)
                                        }
                        onSpacerSizeChanged: (sectionId, widgetIndex, newSize) => {
                                                 buckBarTab.handleSpacerSizeChanged(
                ...
                StyledRect {
                    ...
                    WidgetsTabSection {
                        ...
                        sectionId: "center"
                        allWidgets: buckBarTab.baseWidgetDefinitions
                        items: buckBarTab.getItemsForSection("center")
                        onItemEnabledChanged: (sectionId, itemId, enabled) => {
                                                  buckBarTab.handleItemEnabledChanged(
                                                      sectionId,
                                                      itemId, enabled)
                ...
                StyledRect {
                    ...
                    WidgetsTabSection {
                        ...
                        anchors.fill: parent
                        anchors.margins: Theme.spacingL
                        title: SettingsData.buckBarIsVertical ? I18n.tr("Bottom Section") : I18n.tr("Right Section")
                        titleIcon: "format_align_right"
                        sectionId: "right"
                        allWidgets: buckBarTab.baseWidgetDefinitions
                        items: buckBarTab.getItemsForSection("right")
                        onItemEnabledChanged: (sectionId, itemId, enabled) => {
                                                  buckBarTab.handleItemEnabledChanged(
                                                      sectionId,
                                                      itemId, enabled)
    ...
    WidgetSelectionPopup {
        ...
        parentModal: buckBarTab.parentModal
        onWidgetSelected: (widgetId, targetSection) => {
                              buckBarTab.addWidgetToSection(widgetId,
                                                           targetSection)
                          }
    }
}

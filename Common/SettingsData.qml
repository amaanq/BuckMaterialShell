...
Singleton {
    ...
    function cleanupUnusedKeys() {
        const validKeys = [
            ...
            "buckBarTransparency", "buckBarWidgetTransparency", "popupTransparency", "dockTransparency",
            ...
            "buckBarLeftWidgets", "buckBarCenterWidgets", "buckBarRightWidgets",
            ...
            "fontWeight", "fontScale", "buckBarFontScale", "notepadUseMonospace",
            ...
            "cornerRadius", "notificationOverlayEnabled", "buckBarAutoHide",
            "buckBarOpenOnOverview", "buckBarVisible", "buckBarSpacing", "buckBarBottomGap",
            "buckBarInnerPadding", "buckBarSquareCorners", "buckBarNoBackground",
            "buckBarGothCornersEnabled", "buckBarBorderEnabled", "buckBarBorderColor",
            "buckBarBorderOpacity", "buckBarBorderThickness", "popupGapsAuto", "popupGapsManual",
            "buckBarPosition", "lockScreenShowPowerActions", "enableFprint", "maxFprintTries",
    ...
    function sendTestNotification(index) {
        const notifications = [
            ["Notification Position Test", "Dykwabi test notification 1 of 3 ~ Hi there!", "preferences-system"],
            ["Second Test", "Dykwabi Notification 2 of 3 ~ Check it out!", "applications-graphics"],
            ["Third Test", "Dykwabi notification 3 of 3 ~ Enjoy!", "face-smile"]
        ]

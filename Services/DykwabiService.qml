...
Singleton {
    ...
    readonly property bool verboseLogs: Quickshell.env("DYKWABI_VERBOSE_LOGS") === "1"
    ...
    function handleSubscriptionEvent(response) {
        ...
        if (service === "server") {
            ...
            console.log("DykwabiService: Connected (API v" + apiVersion + ") -", JSON.stringify(capabilities))

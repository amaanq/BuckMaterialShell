...
Item {
    ...
    Loader {
        ...
        sourceComponent: BuckBar {
            hyprlandOverviewLoader: buckBarLoader.hyprlandOverviewLoaderRef
    ...
    Loader {
        ...
        sourceComponent: Component {
            BuckDashPopout {
                ...
                Component.onCompleted: {
                    PopoutService.buckDashPopout = buckDashPopout
                }
            }
        }
    }
    ...
    DykwabiShellIPC {
        ...
        buckDashPopoutLoader: buckDashPopoutLoader
        notepadSlideoutVariants: notepadSlideoutVariants
        hyprKeybindsModalLoader: hyprKeybindsModalLoader
        buckBarLoader: buckBarLoader

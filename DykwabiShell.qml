...
ShellRoot {
  ...
  Loader {
      ...
      property var currentPosition: SettingsData.buckBarPosition

      sourceComponent: BuckBar {
  ...
  IpcHandler {
      function open(tab: string): string {
          ...
          if (buckDashPopoutLoader.item) {
              ...
              case "media":
                  ...
                  break
              case "weather":
                  buckDashPopoutLoader.item.currentTabIndex = SettingsData.weatherEnabled ? 2 : 0
                  break
              default:
                  buckDashPopoutLoader.item.currentTabIndex = 0
                  break
              }
              buckDashPopoutLoader.item.setTriggerPosition(Screen.width / 2, Theme.barHeight + Theme.spacingS, 100, "center", Screen)
              buckDashPopoutLoader.item.dashVisible = true
      ...
      function close(): string {
          if (buckDashPopoutLoader.item) {
              buckDashPopoutLoader.item.dashVisible = false

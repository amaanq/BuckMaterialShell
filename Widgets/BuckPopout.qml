...
PanelWindow {
    ...
    readonly property real alignedX: Theme.snap((() => {
        if (SettingsData.buckBarPosition === SettingsData.Position.Left) {
            return triggerY + SettingsData.buckBarBottomGap
        } else if (SettingsData.buckBarPosition === SettingsData.Position.Right) {
            return screenWidth - triggerY - SettingsData.buckBarBottomGap - popupWidth
        } else {
    ...
    readonly property real alignedY: Theme.snap((() => {
        if (SettingsData.buckBarPosition === SettingsData.Position.Left || SettingsData.buckBarPosition === SettingsData.Position.Right) {
        ...
        } else if (SettingsData.buckBarPosition === SettingsData.Position.Bottom) {
    ...
    Loader {
        ...
        layer.enabled: Quickshell.env("DYKWABI_DISABLE_LAYER") !== "true" && Quickshell.env("DYKWABI_DISABLE_LAYER") !== "1"
        layer.smooth: true
        ...
        Translate {
            ...
            readonly property bool barTop: SettingsData.buckBarPosition === SettingsData.Position.Top
            readonly property bool barBottom: SettingsData.buckBarPosition === SettingsData.Position.Bottom
            readonly property bool barLeft: SettingsData.buckBarPosition === SettingsData.Position.Left
            readonly property bool barRight: SettingsData.buckBarPosition === SettingsData.Position.Right
